...
surface, while true uninstall or surface removal clears it. This persistence
contract does not provide failed-N+1 fallback: candidate readiness, cutover,
rollback, reviewed backend bindings, and native UI hosting remain release gates.
