...
The compatibility lock pins the verified Phase 1 cross-product baseline for
...
owner-compiled releases through A3S ORM/PostgreSQL and exposes the same CQRS
authority through REST `1.13.0`, the maintained TypeScript client, CLI, and
Management MCP. Persisted WorkflowRun execution, protected submissions, and
human-task product surfaces remain later gates. Component roadmaps and the
...
| Cloud | R0–E0 is the verified cumulative baseline; the compatibility manifest additionally pins native Form compilation/evaluation, Form/Flow interaction contracts, and the tenant-isolated Form draft/immutable-release lifecycle across REST, TypeScript client, CLI, and Management MCP. WorkflowRun execution, protected submissions, and end-to-end human tasks remain unavailable |
