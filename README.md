...
| --- | --- | --- |
| **Build** | Agent session, model, tools, context, permissions | [Code](crates/code/), [TUI](crates/tui/), [Web](apps/web/), [Desktop](apps/desktop/) |
...
| Group | Projects |
| --- | --- |
| Product hosts | [CLI](crates/cli/), [Code](crates/code/), [Ash](crates/ash/), [Web](apps/web/), [Desktop](apps/desktop/), [Windhole](apps/windhole/), [Cloud](apps/cloud/) |
