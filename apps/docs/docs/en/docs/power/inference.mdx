...
Power 0.6.0 deepens the Colibri-inspired parts of that runtime without creating
...
Exact positional/direct tensor reads and an independent cold-storage A/B are
tracked in [Power issue #19](https://github.com/A3S-Lab/Power/issues/19).
Power 0.6.0 does not claim those benchmark results or enable direct I/O by
default.

A3S OCR 0.5.0 uses Power 0.6.0 for its Rust PP-OCRv6 and Unlimited-OCR
