...
Power 0.5.0 deepens the Colibri-inspired parts of that runtime without creating
...
but Power does not embed either model. The embedded dependency closure excludes
the Power server, HTTP clients, ONNX Runtime, and browser automation. See the
