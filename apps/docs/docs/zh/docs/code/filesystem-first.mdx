...
1. [约定大于配置](/docs/code/convention-over-configuration)
...
5. [Agent 目录](/docs/code/agent-dir)
6. [agents/ 角色目录](/docs/code/filesystem-agents)
7. [skills/ 技能目录](/docs/code/filesystem-skills)
8. [tools/ 工具目录](/docs/code/filesystem-tools)
9. [schedules/ 调度目录](/docs/code/filesystem-schedules)
