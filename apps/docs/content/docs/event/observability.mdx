...
|-------|------|-------------|
| `publish_count` | `u64` | Total events published successfully |
| `publish_errors` | `u64` | Total publish failures |
...
| `validation_errors` | `u64` | Schema validation failures |
| `encrypt_count` | `u64` | Encryption operations |
| `decrypt_count` | `u64` | Decryption operations |
| `avg_publish_latency_us` | `u64` | Average publish latency in microseconds |
| `max_publish_latency_us` | `u64` | Maximum single-publish latency in microseconds |
...
|-----------|------|--------|
| Publish | `event.publish` | `event_id`, `subject`, `category`, `provider` |
| Subscribe | `event.subscribe` | `subscriber`, `subjects`, `durable`, `provider` |
| Unsubscribe | `event.unsubscribe` | `consumer`, `error` (on failure) |
