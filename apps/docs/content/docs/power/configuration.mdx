---
title: Configuration
description: TOML configuration and Ollama-compatible environment variables
---

# Configuration

A3S Power uses TOML configuration with full Ollama-compatible environment variable overrides.
