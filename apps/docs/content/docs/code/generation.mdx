...
The generation RPCs send messages to the LLM and return responses. These are low-level RPCs — for most use cases, prefer the [Agentic Loop](/docs/code/agentic) which handles tool execution automatically.
