...
description: 10 built-in tools for file operations, shell execution, search, and web access
---
...
A3S Code ships with 10 built-in tools covering file operations, shell execution, search, and web access. All tools execute in-process via native Rust implementations.
