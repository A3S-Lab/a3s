...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
  ...
  <div className="border rounded-lg p-4">
    ...
    <p className="text-sm text-muted-foreground">
      Permission system, HITL confirmation, skill-based tool restrictions, audit logs.
    </p>
  </div>
  ...
  <div className="border rounded-lg p-4">
    ...
    <p className="text-sm text-muted-foreground">
      Multi-machine task distribution for horizontal scaling.
    </p>
  </div>
  ...
  <div className="border rounded-lg p-4">
    ...
    <p className="text-sm text-muted-foreground">
      Parallel execution, planning, goal tracking, context-aware memory.
    </p>
  </div>
</div>
...
1. **Default Security Provider** — Auto-redact sensitive data (SSN, API keys, emails, etc.)
2. **Permission System** — Allow/Deny/Ask rules per tool
3. **Skill-Based Tool Restrictions** — Skills define allowed tools
4. **HITL Confirmation** — Require human approval for sensitive operations
...
- `find-bugs` — Identify potential bugs
...
**Custom Skills** — Markdown files with YAML frontmatter (Claude Code compatible):
...
**Parallel Execution** — Query-lane tools (read, grep, glob, ls) run in parallel automatically.

**Planning Mode** — Decompose complex tasks into steps:
...
- **[Sessions](/docs/code/sessions)** — Session management and lifecycle
...
### Security & Safety
- **[Security](/docs/code/security)** — Security features and best practices
- **[Skills](/docs/code/skills)** — Skill system and tool restrictions

### Tools & Capabilities
- **[Tools](/docs/code/tools)** — Built-in tools reference
- **[MCP](/docs/code/mcp)** — External tool integration
- **[Subagents](/docs/code/subagents)** — Delegate to specialized agents

### Extensions
- **[Multi-Machine Distribution](/docs/code/multi-machine)** — Horizontal scaling guide
- **[Hooks](/docs/code/hooks)** — Lifecycle events and custom logic
- **[Memory](/docs/code/memory)** — Long-term memory system
- **[Context](/docs/code/context)** — RAG and context providers
- **[Persistence](/docs/code/persistence)** — Session persistence
- **[Telemetry](/docs/code/telemetry)** — Cost tracking and metrics
