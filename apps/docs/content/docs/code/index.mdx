...
<Callout type="info">
**Test Coverage:** 1179 tests, 100% pass rate (includes 8 resilience tests) | **Extension Points:** 14 trait-based | **Built-in Tools:** 11 (12 with `sandbox` feature)
</Callout>
...
| **Sandbox** | `sandbox` | Execute in A3S Box MicroVM (`sandbox` feature) |
...
2. **Permission System** — Allow/Deny/Ask rules per tool with wildcard matching
3. **Skill-Based Tool Restrictions** — Skills define allowed tools via `allowed-tools`
...
- **[Examples](/docs/code/examples)** — Integration tests and usage patterns
...
- **[Tasks](/docs/code/tasks)** — Planning and wave-based execution
- **[Lane Queue](/docs/code/lane-queue)** — Priority routing and queue features

### Security & Safety
- **[Security](/docs/code/security)** — Permission system, PII redaction, HITL
...
### Extensions
- **[Multi-Machine](/docs/code/multi-machine)** — Horizontal scaling guide
- **[Hooks](/docs/code/hooks)** — Lifecycle events
- **[Memory](/docs/code/memory)** — Long-term memory
- **[Context](/docs/code/context)** — RAG providers
- **[Persistence](/docs/code/persistence)** — Session storage
