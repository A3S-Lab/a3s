...
<TypeTable
  type={{
    "压缩前消息数": {
      description: "Rust: messages_before · Python/TypeScript: messages_before / messagesBefore · 描述: 压缩前的消息数量",
    },
    "压缩后消息数": {
      description: "Rust: messages_after · Python/TypeScript: messages_after / messagesAfter · 描述: 压缩后的消息数量",
    },
    "节省的 token": {
      description: "Rust: tokens_saved · Python/TypeScript: tokens_saved / tokensSaved · 描述: 大约释放的 token 数",
    },
  }}
/>
