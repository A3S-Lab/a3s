...
<TypeTable
  type={{
    "启用 lane 功能": {
      description: "Rust: .with_lane_features() · Python: enable_all_features=True · TypeScript: enableAllFeatures: true · 默认值: false",
    },
    "启用指标": {
      description: "Rust: .with_metrics() · Python: enable_metrics=True · TypeScript: enableMetrics: true · 默认值: false",
    },
    "Query 并发数": {
      description: "Rust: .query_max_concurrency(n) · Python: query_max_concurrency=n · TypeScript: queryMaxConcurrency: n · 默认值: 10",
    },
    "Execute 并发数": {
      description: "Rust: .execute_max_concurrency(n) · Python: execute_max_concurrency=n · TypeScript: executeMaxConcurrency: n · 默认值: 5",
    },
  }}
/>
