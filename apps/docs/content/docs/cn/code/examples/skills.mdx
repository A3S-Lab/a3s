...
**运行：** `npx ts-node examples/test_custom_skills_agents.ts`
**源码：** [`sdk/node/examples/test_custom_skills_agents.ts`](https://github.com/A3S-Lab/Code/blob/main/sdk/node/examples/test_custom_skills_agents.ts)
</Tab>
<Tab value="Python">
```python
...
<TypeTable
  type={{
    ...
    "自定义注册表": {
      description: "Rust: .with_skill_registry(Arc::new(r)) · Python: _（仅 Rust）_ · TypeScript: _（仅 Rust）_ · 默认值: None",
    },
  }}
/>
