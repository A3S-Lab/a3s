...
<TypeTable
  type={{
    "注册 hook": {
      description: "Python: session.register_hook(id, event, fn) · TypeScript: session.registerHook(id, event, fn)",
    },
    "注册处理器": {
      description: "Python: _（与注册合并）_ · TypeScript: _（与注册合并）_",
    },
    "注销": {
      description: "Python: session.unregister_hook(id) · TypeScript: session.unregisterHook(id)",
    },
    "计数": {
      description: "Python: session.hook_count() · TypeScript: session.hookCount()",
    },
  }}
/>
