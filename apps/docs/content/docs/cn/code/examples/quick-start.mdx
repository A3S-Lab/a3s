...
**运行：** `cargo run --example 01_basic_send`
**源码：** [`core/examples/01_basic_send.rs`](https://github.com/A3S-Lab/Code/blob/main/core/examples/01_basic_send.rs)
</Tab>
<Tab value="Python">
```python
import a3s_code
...
<TypeTable
  type={{
    ...
    "解析重试": {
      description: "Rust: .with_parse_retries(n) · Python: max_parse_retries=n · TypeScript: maxParseRetries: n · 默认值: 3",
    },
    "工具超时": {
      description: "Rust: .with_tool_timeout(ms) · Python: tool_timeout_ms=ms · TypeScript: toolTimeoutMs: ms · 默认值: 30000",
    },
    "熔断器": {
      description: "Rust: .with_circuit_breaker(n) · Python: circuit_breaker_threshold=n · TypeScript: circuitBreakerThreshold: n · 默认值: 5",
    },
  }}
/>
