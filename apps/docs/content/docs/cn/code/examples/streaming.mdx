...
<TypeTable
  type={{
    ...
    "等待完成": {
      description: "Rust: handle.await?? · Python: _（自动）_ · Node.js: _（自动）_",
    },
  }}
/>
...
<TypeTable
  type={{
    "Agent 启动": {
      description: "Rust 变体: AgentEvent::Start · Python/Node.js type: start",
    },
    "LLM 轮次开始": {
      description: "Rust 变体: AgentEvent::TurnStart · Python/Node.js type: turn_start · 字段: turn",
    },
    "LLM 轮次结束": {
      description: "Rust 变体: AgentEvent::TurnEnd · Python/Node.js type: turn_end · 字段: turn, usage",
    },
    "文本片段": {
      description: "Rust 变体: AgentEvent::TextDelta · Python/Node.js type: text_delta · 字段: text",
    },
    "工具开始": {
      description: "Rust 变体: AgentEvent::ToolStart · Python/Node.js type: tool_start · 字段: name, args",
    },
    "工具完成": {
      description: "Rust 变体: AgentEvent::ToolEnd · Python/Node.js type: tool_end · 字段: name, exit_code, output",
    },
    "工具输出片段": {
      description: "Rust 变体: AgentEvent::ToolOutputDelta · Python/Node.js type: tool_output_delta · 字段: text",
    },
    "RAG 检索中": {
      description: "Rust 变体: AgentEvent::ContextResolving · Python/Node.js type: context_resolving · 字段: query",
    },
    "RAG 检索完成": {
      description: "Rust 变体: AgentEvent::ContextResolved · Python/Node.js type: context_resolved · 字段: chunks",
    },
    "Agent 完成": {
      description: "Rust 变体: AgentEvent::End · Python/Node.js type: end · 字段: text, usage",
    },
  }}
/>
