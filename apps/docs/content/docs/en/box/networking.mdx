...
<TypeTable
  type={{
    "gateway()": {
      description: "Returns the gateway IP",
    },
    "cidr()": {
      description: {`Returns the CIDR string (e.g., \`"10.88.0.0/24"\`)`},
    },
    "broadcast()": {
      description: "Returns the broadcast address",
    },
    "capacity()": {
      description: "Returns the number of available host addresses",
    },
    "next_ip()": {
      description: "Allocates the next available IP",
    },
  }}
/>
...
<TypeTable
  type={{
    "4088": {
      description: "Service: Agent control · Purpose: Health checks, metrics",
    },
    "4089": {
      description: "Service: Exec server · Purpose: Command execution",
    },
    "4090": {
      description: "Service: PTY server · Purpose: Terminal I/O",
    },
    "4091": {
      description: "Service: Attestation server · Purpose: TEE operations (RA-TLS)",
    },
  }}
/>
