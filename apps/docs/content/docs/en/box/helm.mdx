...
<TypeTable
  type={{
    "a3s_box_vm_boot_duration_seconds": {
      type: "Histogram",
      description: "VM boot latency",
    },
    "a3s_box_vm_count": {
      type: "Gauge",
      description: "Running VM count by state",
    },
    "a3s_box_vm_created_total": {
      type: "Counter",
      description: "Total VMs created",
    },
    "a3s_box_exec_total": {
      type: "Counter",
      description: "Total exec calls",
    },
    "a3s_box_exec_duration_seconds": {
      type: "Histogram",
      description: "Exec latency",
    },
    "a3s_box_image_pull_total": {
      type: "Counter",
      description: "Total image pulls",
    },
    "a3s_box_image_build_total": {
      type: "Counter",
      description: "Total image builds",
    },
    "a3s_box_rootfs_cache_hits": {
      type: "Counter",
      description: "Rootfs cache hits",
    },
    "a3s_box_warm_pool_size": {
      type: "Gauge",
      description: "Current idle pool size",
    },
    "a3s_box_warm_pool_capacity": {
      type: "Gauge",
      description: "Configured pool capacity",
    },
  }}
/>
