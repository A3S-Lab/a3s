...
<TypeTable
  type={{
    ...
    "Backend Layer": {
      description: "Pluggable inference engines: mistralrs (pure Rust, default) and llama.cpp (optional). Supports GGUF, SafeTensors, Vision, and Embedding model formats.",
    },
    "Model Layer": {
