...
- **Headless Browser** — Lightpanda (default, 59MB, &lt;100ms) or Chrome for JS-rendered engines (Google, Baidu, Bing China).
- **Auto-Install Browser** — Detects or downloads Lightpanda/Chrome for Testing when no browser is found.
...
<TypeTable
  type={{
    "Rust": {
      description: "Package: [a3s-search](https://crates.io/crates/a3s-search) · Install: a3s-search = '0.9' in Cargo.toml",
    },
    "Python": {
