...
<TypeTable
  type={{
    total_pending: { type: 'usize', description: 'Commands waiting across all lanes' },
    total_active: { type: 'usize', description: 'Commands executing across all lanes' },
    dead_letter_count: { type: 'usize', description: 'Failed commands in the DLQ' },
    lanes: { type: 'HashMap<String, LaneStatus>', description: 'Per-lane breakdown' },
  }}
/>
