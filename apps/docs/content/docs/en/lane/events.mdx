...
<TypeTable
  type={{
    "queue.command.submitted": {
      description: "When: submit() accepted · Payload fields: lane_id",
    },
    "queue.command.started": {
      description: "When: Scheduler dispatched · Payload fields: lane_id, command_id, command_type",
    },
    "queue.command.completed": {
      description: "When: Returned Ok · Payload fields: lane_id, command_id",
    },
    "queue.command.retry": {
      description: "When: Failed, will retry · Payload fields: lane_id, command_id, attempt",
    },
    "queue.command.dead_lettered": {
      description: "When: Moved to DLQ · Payload fields: lane_id, command_id, command_type",
    },
    "queue.command.failed": {
      description: "When: Terminal failure · Payload fields: lane_id, command_id, error",
    },
    "queue.command.timeout": {
      description: "When: Timed out · Payload fields: lane_id, command_id, error",
    },
  }}
/>
...
<TypeTable
  type={{
    "queue.lane.pressure": {
      description: "When: pending >= threshold (first crossing) · Payload fields: lane_id",
    },
    "queue.lane.idle": {
      description: "When: pending == 0 after being pressured · Payload fields: lane_id",
    },
  }}
/>
...
<TypeTable
  type={{
    "queue.shutdown.started": {
      description: "When: shutdown() called",
    },
  }}
/>
