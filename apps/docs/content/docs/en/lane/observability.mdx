...
<TypeTable
  type={{
    "lane.commands.submitted": {
      description: "Total commands submitted",
    },
    ...
    "lane.commands.timeout": {
      description: "Timed out commands",
    },
    "lane.commands.retried": {
      description: "Retry attempts",
    },
    "lane.commands.dead_lettered": {
      description: "Moved to DLQ",
    },
  }}
/>
...
<TypeTable
  type={{
    "lane.queue.depth.<lane_id>": {
      description: "Pending commands per lane",
    },
    "lane.queue.active.<lane_id>": {
      description: "Active commands per lane",
    },
  }}
/>
...
<TypeTable
  type={{
    "Warning": {
      description: {`Queue Depth Trigger: >= warning threshold · Latency Trigger: >= warning threshold`},
    },
    "Critical": {
      description: {`Queue Depth Trigger: >= critical threshold · Latency Trigger: >= critical threshold`},
    },
  }}
/>
