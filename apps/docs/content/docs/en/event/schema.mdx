...
<TypeTable
  type={{
    "Backward": {
      description: "Meaning: New schema can read old data · Example: Added optional field",
    },
    "Forward": {
      description: "Meaning: Old schema can read new data · Example: Removed optional field",
    },
    "Full": {
      description: "Meaning: Compatible both ways · Example: No field changes",
    },
    "None": {
      description: "Meaning: Breaking change · Example: Added required field",
    },
  }}
/>
