...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
  ...
  <div className="border rounded-lg p-4">
    ...
    <ul className="text-sm text-muted-foreground space-y-1">
      <li><a href="/docs/code/security">Security</a> — Permission policies, HITL, SecurityProvider</li>
      <li><a href="/docs/code/hooks">Hooks</a> — Lifecycle interception and control</li>
      <li><a href="/docs/code/orchestrator">Orchestrator</a> — Multi-agent coordination and runtime control</li>
    </ul>
  </div>
