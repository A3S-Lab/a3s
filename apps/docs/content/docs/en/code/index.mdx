...
| TUI | [`a3s code`](/docs/code/tui) streams runtime events into a terminal workspace with tool activity, approvals, memory, files, sessions, OS assets, effort profiles, DynamicWorkflowRuntime, and RemoteUI controls. |
...
- [A3S Code TUI](/docs/code/tui) explains install, config discovery, slash commands, effort profiles, dynamic workflows, OS Runtime, and RemoteUI.
