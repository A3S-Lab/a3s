...
workspace shipped by the [`a3s` CLI](https://github.com/A3S-Lab/a3s); it drives
...
| `a3s code` TUI | Running the ready terminal coding-agent workspace. | [A3S-Lab/a3s](https://github.com/A3S-Lab/a3s) |
