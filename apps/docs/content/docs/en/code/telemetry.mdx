...
| `input_tokens` | `u32` | Prompt tokens |
| `output_tokens` | `u32` | Completion tokens |
| `cache_read_tokens` | `u32` | Prompt cache read tokens |
| `cache_write_tokens` | `u32` | Prompt cache write tokens |
| `cost_usd` | `f64` | Estimated cost in USD |
...
| `RUST_LOG` | Log level filter (e.g. `a3s_code_core=debug`) |
