...
<TypeTable
  type={{
    "Enable auto-compact": {
      description: "Python: auto_compact=True · TypeScript: autoCompact: true · Default: false",
    },
    "Threshold (0.0–1.0)": {
      description: "Python: auto_compact_threshold=f · TypeScript: autoCompactThreshold: f · Default: 0.8",
    },
  }}
/>
...
<TypeTable
  type={{
    messages_before: { type: 'usize', description: 'Message count before compaction. Python: `messages_before`, TypeScript: `messagesBefore`' },
    messages_after: { type: 'usize', description: 'Message count after compaction. Python: `messages_after`, TypeScript: `messagesAfter`' },
    tokens_saved: { type: 'usize', description: 'Approximate tokens freed. Python: `tokens_saved`, TypeScript: `tokensSaved`' },
  }}
/>
