...
<TypeTable
  type={{
    "Enable planning": {
      description: "Python: planning=True · TypeScript: planning: true · Default: false",
    },
    "Enable goal tracking": {
      description: "Python: goal_tracking=True · TypeScript: goalTracking: true · Default: false",
    },
  }}
/>
