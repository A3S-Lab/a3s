...
<TypeTable
  type={{
    "Model override": {
      description: "Rust: .with_model(\"provider/model\") · Python: model=\"provider/model\" · TypeScript: model: \"provider/model\"",
    },
    "Temperature": {
      description: "Rust: .with_temperature(0.3) · Python: temperature=0.3 · TypeScript: temperature: 0.3",
    },
    "Thinking budget": {
      description: "Rust: .with_thinking_budget(10000) · Python: thinking_budget=10000 · TypeScript: thinkingBudget: 10000",
    },
  }}
/>
