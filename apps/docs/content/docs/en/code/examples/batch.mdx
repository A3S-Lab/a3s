...
|-------|------|----------|-------------|
| `invocations` | `array` | ✅ | List of tool calls to execute in parallel |
| `invocations[].tool` | `string` | ✅ | Name of the tool to call |
| `invocations[].args` | `object` | ✅ | Arguments passed to the tool |
