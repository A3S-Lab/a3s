...
**Run:** `cargo run --example 01_basic_send`
**Source:** [`core/examples/01_basic_send.rs`](https://github.com/A3S-Lab/Code/blob/main/core/examples/01_basic_send.rs)
</Tab>
<Tab value="Python">
```python
import a3s_code
...
<TypeTable
  type={{
    "Permissive policy": {
      description: "Rust: .with_permissive_policy() · Python: permissive=True · TypeScript: permissive: true · Default: false",
    },
    "Parse retries": {
      description: "Rust: .with_parse_retries(n) · Python: max_parse_retries=n · TypeScript: maxParseRetries: n · Default: 3",
    },
    "Tool timeout": {
      description: "Rust: .with_tool_timeout(ms) · Python: tool_timeout_ms=ms · TypeScript: toolTimeoutMs: ms · Default: 30000",
    },
    "Circuit breaker": {
      description: "Rust: .with_circuit_breaker(n) · Python: circuit_breaker_threshold=n · TypeScript: circuitBreakerThreshold: n · Default: 5",
    },
  }}
/>
...
<TypeTable
  type={{
    ...
    "Total tokens": {
      description: "Rust: result.usage.total_tokens · Python: result.total_tokens · TypeScript: result.totalTokens",
    },
    "Tool call count": {
