...
<TypeTable
  type={{
    "Permissive policy": {
      description: "Rust: .with_permissive_policy() · Python: permissive=True · Node.js: permissive: true · Default: false",
    },
    "Parse retries": {
      description: "Rust: .with_parse_retries(n) · Python: max_parse_retries=n · Node.js: maxParseRetries: n · Default: 3",
    },
    "Tool timeout": {
      description: "Rust: .with_tool_timeout(ms) · Python: tool_timeout_ms=ms · Node.js: toolTimeoutMs: ms · Default: 30000",
    },
    "Circuit breaker": {
      description: "Rust: .with_circuit_breaker(n) · Python: circuit_breaker_threshold=n · Node.js: circuitBreakerThreshold: n · Default: 5",
    },
  }}
/>
