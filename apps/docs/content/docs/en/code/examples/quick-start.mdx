...
<Callout type="error">
**IMPORTANT:** You must configure `permissive: true` in SessionOptions, or you'll get the error: "confirmation manager isn't configured". This allows tools to execute without manual confirmation. See [Security](/docs/code/security) for production configurations.
</Callout>
