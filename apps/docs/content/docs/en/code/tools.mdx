---
title: Tools
description: 15 built-in tools for file operations, shell execution, search, web access, git worktree, subagent delegation
---
...
A3S Code ships with **15 built-in tools**. All tools execute in-process via native Rust implementations.
