...
description: 13 built-in tools (14 with sandbox) for file operations, shell execution, search, web access, git worktree, and subagent delegation
---
...
<TypeTable
  type={{
    ...
    "codesearch": {
      description: "Purpose: Semantic code search · Example: Find code by meaning via vector embeddings",
    },
    "sandbox": {
