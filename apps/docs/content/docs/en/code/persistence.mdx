...
<TypeTable
  type={{
    "Save session": {
      description: "Description: Persist current state",
    },
    "Load session": {
      description: "Description: Resume from stored state",
    },
    "List sessions": {
      description: "Description: List all saved session IDs",
    },
    "Delete session": {
      description: "Description: Remove stored session",
    },
  }}
/>
