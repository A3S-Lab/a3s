...
<TypeTable
  type={{
    model: {
      type: 'string',
      description: 'Model override in `provider/model` format (e.g., `openai/gpt-4o`). "provider/model")`, TS: `model: "provider/model"`, Python: `model="provider/model"`',
    },
    skill_dirs: {
      type: 'string[]',
...
<TypeTable
  type={{
    model: {
      ...
      description: 'Model in `provider/model` format. "..."`, Python: `model="..."`',
    },
    permissive: {
      type: 'bool',
      default: 'false',
    ...
    default_security: {
      type: 'bool',
      default: 'false',
      description: 'Enable default security provider. TS: `defaultSecurity: true`, Python: `default_security=True`',
    },
    file_memory: {
      type: 'Option<string>',
      default: 'None',
      description: 'Path for file-backed memory. TS: `memoryDir: path`, Python: `memory_dir=path`',
    },
    auto_compact: {
      type: 'bool',
      default: 'false',
