...
|------|---------|---------|
| Episodic | Session events and interactions | FileMemoryStore (default) |
| Semantic | Facts and knowledge | FileMemoryStore (default) |
| Procedural | Successful patterns and workflows | FileMemoryStore (default) |
| Working | Current task context | In-memory (short-lived) |
