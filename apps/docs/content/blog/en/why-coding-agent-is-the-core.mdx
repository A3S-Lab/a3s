...
## IV. A3S Code + A3S Box: Providing a Sandbox Environment for Agents
...
### 4.2 Why Do Agents Need a Sandbox?
...
### 4.3 Integration: Route Agent Code Execution to Box
...
### 4.4 Extended Box Tools: File Upload/Download, Snapshots
...
### 4.5 Skill Mechanism: Teaching the Agent How to Operate Box
...
### 4.6 Complete Example: Sandboxed Coding Agent
...
## V. Four Positions, Three Design Philosophies
...
## VI. Building a Claude Code-Like Product with the TypeScript SDK
...
## VII. Building an Agentic Finance Application
...
## VIII. From Single Machine to Multi-Machine: The Value of Lane Queues
