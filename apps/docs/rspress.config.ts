...
const copy = {
  cn: {
    ...
    description: 'A3S 项目索引与工程博客。查看 35 个项目的职责、交付阶段、发布通道和代码入口。',
    ecosystem: '生态',
    blog: '博客',
    articles: '文章',
    alternate: 'EN',
  ...
  en: {
    ...
    description: 'The A3S project index and engineering blog. Browse 35 projects, their delivery stages, release channels, sites, and source.',
    ecosystem: 'Ecosystem',
    blog: 'Blog',
    articles: 'Articles',
    alternate: '中文',
