...
const copy = {
  cn: {
    ...
    description: 'A3S 生态首页与工程博客。查看 35 个项目的职责、开发阶段、网站和代码入口。',
    ecosystem: '生态',
    blog: '博客',
    articles: '文章',
    alternate: 'EN',
  ...
  en: {
    ...
    description: 'The A3S ecosystem homepage and engineering blog. Explore 35 projects, their delivery stages, sites, and repositories.',
    ecosystem: 'Ecosystem',
    blog: 'Blog',
    articles: 'Articles',
    alternate: '中文',
