...
export const homeContent = {
  en: {
    ...
    architecture: {
      eyebrow: 'ARCHITECTURE ATLAS / 34 PROJECTS / LIVE',
      title: 'Thirty-four projects. One inspectable system.',
      description:
        'Select any project or node to trace its entrypoints, core ownership, contracts, execution boundary, and evidence path.',
    },
    principles: {
    ...
    ecosystem: {
      eyebrow: '34 INDEPENDENT PROJECTS',
      title: 'Independent releases. Shared capability surface.',
    },
    quickstart: {
  ...
  cn: {
    ...
    architecture: {
      eyebrow: '架构图谱 / 34 个项目 / 实时交互',
      title: '34 个项目，不是 34 个孤岛。',
      description: '选择任一项目或节点，追踪它的入口、核心职责、契约、执行边界与证据路径。',
    },
    principles: {
      eyebrow: '设计原则 / 05',
