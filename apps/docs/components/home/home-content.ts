...
export const homeContent = {
  en: {
    ...
    hero: {
      ...
      description:
        'Thirty-six projects cover agent products, runtimes, data, protocols, and infrastructure, with clear ownership, delivery status, sites, and repositories.',
      primaryAction: 'View 36 projects',
      secondaryAction: 'Read the blog',
    },
    signal: ['36 projects', '8 project previews', '3 architecture layers', 'One index for sites and code'],
    principles: {
    ...
    quickstart: {
      ...
      note: 'Stable release · checksum verified · atomic activation',
      installers: [
        {
          id: 'unix',
          label: 'macOS / Linux',
  ...
  cn: {
    ...
    hero: {
      ...
      accent: '生态系统。',
      description:
        '36 个项目覆盖 Agent 产品、运行时、数据、协议和基础设施。每个项目都有明确职责、开发阶段、网站和代码入口。',
      primaryAction: '查看 36 个项目',
      secondaryAction: '阅读博客',
    },
    signal: ['36 个项目', '8 个项目预览', '3 个架构层', '网站与代码统一索引'],
    principles: {
      eyebrow: '工程约束 / 05',
      title: 'A3S 遵循的工程约束。',
