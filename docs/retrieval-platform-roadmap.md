...
the root submodule is advanced to Vec `3668561a4cf6b8c18c3b0423c8d9c7122a42f3fb`
...
CI run `33646546812` passed all hosted quality,
...
- `crates/vec` is the `A3S-Lab/Vec` git submodule at `3668561`. Format-4
