...
the root submodule is advanced to Vec `747560eb692443b0910014c6b835944afa30d45b`
...
- `crates/vec` is the `A3S-Lab/Vec` git submodule at `747560e`. Format-4
