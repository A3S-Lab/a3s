...
the root submodule is advanced to Vec `18828b0c0188a049446ea57e1416f96948fb66ec`
...
CI run `33643447781` passed all hosted quality,
...
- `crates/vec` is the `A3S-Lab/Vec` git submodule at `18828b0`. Format-4
