...
the root submodule is advanced to Vec `305c6491c8f07efc765bd048e8980b0cdc7264ad`
...
artifact gate. The revision-bound CI run `33635107475` passed all hosted quality,
...
- `crates/vec` is the `A3S-Lab/Vec` git submodule at `305c649`. Format-4
