...
the root submodule is advanced to Vec `dd7e2a144b34704e4abf0b9df0cc54e8d13e1cce`
...
- `crates/vec` is the `A3S-Lab/Vec` git submodule at `dd7e2a1` (latest documentation
