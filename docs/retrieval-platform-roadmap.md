...
the root submodule is advanced to Vec `03e4031f4e117c0dd8c467470dd711feda7c84ed`
...
CI run `33656188603` passed all hosted quality,
...
- `crates/vec` is the `A3S-Lab/Vec` git submodule at `03e4031`. Format-10
...
performance matrix. The all-feature suite currently passes 263 unit/integration
tests plus four doctests (260 unit/integration tests on both the default and
