...
the root submodule is advanced to Vec `8f5472a802a18bcb03eb9d914e5f971ccae84171`
...
CI run `33642236616` passed all hosted quality,
...
- `crates/vec` is the `A3S-Lab/Vec` git submodule at `8f5472a`. Format-4
