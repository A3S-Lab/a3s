...
the root submodule is advanced to Vec `daf69cd7cd794d9d6f25d9f2ba2ed465f4adee2b`
...
artifact gate. The revision-bound CI run `33628336581` passed all hosted quality,
...
- `crates/vec` is the `A3S-Lab/Vec` git submodule at `daf69cd`. Format-4
