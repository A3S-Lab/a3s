...
underlying engine gate is [Vec CI run `33686399240`](https://github.com/A3S-Lab/Vec/actions/runs/33686399240).
These
...
Vec `d6b8345` provides the exact-revision workflow for item 1. It runs only on
