...
`305c6491c8f07efc765bd048e8980b0cdc7264ad`; Code's
...
`33635107475`. That artifact is not a formal release: tagging or registry
...
Vec `305c649` provides the exact-revision workflow for item 1. It runs only on
