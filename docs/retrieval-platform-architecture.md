...
`8f5472a802a18bcb03eb9d914e5f971ccae84171`; Code's
...
`33642236616`. That artifact is not a formal release: tagging or registry
...
Vec `8f5472a` provides the exact-revision workflow for item 1. It runs only on
