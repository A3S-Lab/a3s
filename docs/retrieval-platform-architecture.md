...
`1be075a2026ace8ae666e4670acb01f2949e7e30`; Code's
...
`33648352510`. That artifact is not a formal release: tagging or registry
...
Vec `1be075a` provides the exact-revision workflow for item 1. It runs only on
