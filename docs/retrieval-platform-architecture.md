...
`2d73ef96292174316f917fbaaa765a9ca14ff181`; Code's
...
`33650775524`. That artifact is not a formal release: tagging or registry
...
Vec `2d73ef9` provides the exact-revision workflow for item 1. It runs only on
